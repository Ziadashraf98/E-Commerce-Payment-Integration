<header class="header_section">
    <div class="container">
       <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" @if(Auth::id()) href="{{route('redirect')}}" @else href="{{route('/')}}" @endif><img width="250" src="{{asset('frontend/images/logo.png')}}" alt="#" /></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav">
                <li class="nav-item active">
                   <a class="nav-link" @if(Auth::id()) href="{{route('redirect')}}" @else href="{{route('/')}}" @endif>Home <span class="sr-only">(current)</span></a>
                </li>
